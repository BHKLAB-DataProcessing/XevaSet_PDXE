...
work_dir <- args[1]
work_dir <- '/Users/minoru/Documents/bhklab/xeva_pdxe/'

model <- read.csv(file.path(work_dir, "data/model_info.csv"))
experiment <- read.csv(file.path(work_dir, "data/expriment.csv"))
drugInfo <- read.csv(file.path(work_dir, "data/drug_info.csv"))
...
###----------------
modToBiobaseMap <- read.csv(file.path(work_dir, "data/modToBiobaseMap.csv"))

##-----read mol data ---
RNASeq <- readRDS(file.path(work_dir, "data/molProf_RNASeq.rds"))
cnv <- readRDS(file.path(work_dir, "data/molProf_cnv.rds"))
mutation <- readRDS(file.path(work_dir, "data/molProf_mutation.rds"))
...
saveRDS(pdxe, file.path(work_dir, "Xeva_PDXE.rds"))
